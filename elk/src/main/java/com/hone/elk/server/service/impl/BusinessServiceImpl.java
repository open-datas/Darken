package com.hone.elk.server.service.impl;

import cn.hutool.core.lang.Snowflake;
import cn.hutool.core.util.IdUtil;
import com.hone.elk.server.model.BaseModel;
import com.hone.elk.server.service.BusinessService;
...
public class BusinessServiceImpl implements BusinessService {
     ...
     * @return
     */
    private Long getEntityId(BaseModel t) {
        Long id = t.getId();
        //生成id
        if (id == null) {
            id = generateId();
    ...
    public static void main(String[] args) {
        BusinessServiceImpl esService = new BusinessServiceImpl();
    ...
    private <T> IndexQuery buildIndexQuery(T t) {
        //拿到或更新id
        Long id = getEntityId((BaseModel) t);
